...
export function RebalancingSummary({ summary }: RebalancingSummaryProps) {
  ...
  return (
    <div className="bg-gray-800 rounded-2xl p-4">
      <h2 className="text-sm font-medium text-gray-400 mb-3">调仓摘要</h2>
      <div className="grid grid-cols-3 gap-3">
        <div className="text-center">
          <div className="flex items-center justify-center w-8 h-8 mx-auto mb-1 bg-blue-500/20 rounded-full">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center w-8 h-8 mx-auto mb-1 bg-emerald-500/20 rounded-full">
            <Target size={16} className="text-emerald-500" />
          </div>
          <p className="text-base font-bold text-gray-100">{summary.maxDeviation.toFixed(2)}%</p>
          <p className="text-xs text-gray-500">调仓后偏离度</p>
        </div>
        <div className="text-center">
          <div className="flex items-center justify-center w-8 h-8 mx-auto mb-1 bg-rose-500/20 rounded-full">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center w-8 h-8 mx-auto mb-1 bg-gray-500/20 rounded-full">
